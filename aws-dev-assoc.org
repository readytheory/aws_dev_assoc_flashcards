...
*** Where do you allow port 1024-65535?                               :drill:
    ...
    :DRILL_EASE: 2.6
    :DRILL_LAST_QUALITY: 5
    :DRILL_LAST_REVIEWED: [2021-12-13 Mon 06:53]
    :END:
    .
...
*** Cloudwatch alarms                                                 :drill:
    ...
    :DRILL_EASE: 2.6
    :DRILL_LAST_QUALITY: 5
    :DRILL_LAST_REVIEWED: [2021-12-12 Sun 19:50]
    :END:
...
*** Triggering - counter name                                         :drill:
    ...
    :DRILL_EASE: 2.46
    :DRILL_LAST_QUALITY: 3
    :DRILL_LAST_REVIEWED: [2021-12-13 Mon 06:52]
    :END:
...
*** Cloudwatch metric resolution                                      :drill:
    ...
    :DRILL_EASE: 2.22
    :DRILL_LAST_QUALITY: 3
    :DRILL_LAST_REVIEWED: [2021-12-12 Sun 19:51]
    :END:
...
*** ELB Access  logs                                                  :drill:
    ...
    :DRILL_EASE: 2.8
    :DRILL_LAST_QUALITY: 5
    :DRILL_LAST_REVIEWED: [2021-12-13 Mon 06:54]
    :END:
    Access logs for ELB
...
** Configure rest API                                                 :drill:
   ...
   :DRILL_EASE: 2.36
   :DRILL_LAST_QUALITY: 3
   :DRILL_LAST_REVIEWED: [2021-12-12 Sun 19:52]
   :END:
...
what is lambda cli call to add a layer
update-function-configuration

how to you include libraries for labmda without a big deployment package
layers

limits for mem in lambda
default 128 is min and 3008 Meg is max 64 MB incs

Max env var size (all env vars) for lamda
4kb

Lambd disk capacity of /tmp

how to call a lambda function from cli
invoke
...
create and event source mapping
...
How does an alias difffer from a version in lambda?
 ...
 bonus: alias can point at two versions, with weighting
...
How much concurrency can you resolve per lambda?
...
What Lambda provisioned concurrency?
