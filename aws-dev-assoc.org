...
** Gatway secrets                                                     :drill:
	  should you use [aws authorizer] for sensitive data in API Gateway configuration
...
*** 	   Three types of Gateway API endpoints
	     ...
	     - private (inside VPC)
** Gateway API non-pulic                                              :drill:
	      

	    What is name of API endpoint that is for use by customer's own clients?
*** The name
